...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": "  Consider the augemnted matrix     Given a fixed , what is a neccesary condition for the values of so that the system of equations encoded by has a unique solution?    What does this mean geometrically?    If the rows of are independent, and , then what is the dimension of the solution space of ?   "
},
{
  "id": "activity-basis",
  "level": "2",
...
},
{
  ...
  "number": "2.1.5",
  "title": "",
  "body": "  Consider the region in bound by and . Let and   The feasible region for a canonical maximization problem.       If , what points in satisfy ?    If , what points in satisfy ?    What points in satisfy both ?    What points in satisfy both ?    What points in satisfy both ? What about ?    "
},
{
  "id": "activity-widget",
  "level": "2",
...
},
{
  ...
  "number": "2.1.7",
  "title": "",
  "body": "   Based on , what would be a reasonable sufficient condition for a feasible tableau to have a basic optimal solution?    Some of the .    All of the .    Some of the .    All of the .    Some of the .    All of the .    Some of the .    All of the .     "
},
{
  "id": "sec-pivot-11",
  "level": "2",
...
},
{
  ...
  "number": "6.2.3",
  "title": "",
  "body": " transportation algorithm  algorithm, transportation   To summarize, the Transportation Algorithm is as follows:    We begin with a feasible transportation tableau, probably via VAM .  We then associate with each row an unknown and each column a .    We (by convention) let and select values so that for each basis entry we have that .    Replace every entry with .    If there is a negative entry box this entry and select basis entries so that they, along with the boxed entry, form a cycle.  If each entry is non-negative, GOTO 6.    Shift shipments appropriately along the cycle so that has a non-negative shipping quantity, and one of the selected basis entries has a zero shipping quantity.  Then GOTO 2.    Replace each cost entry with the costs from step 1 and terminate.     "
},
{
...
},
{
  ...
  "number": "6.4.11",
  "title": "",
  "body": " Consider a general balanced transportation problem with warehouses, markets, and cost to ship from warehouse to market is .   Write out a non-canonical minimization problem which models this problem (there should be some equality constraints).   State the dual problem to the transportation problem.   Prove that in , for a valid choice of in step 2 that How does this relate to the dual problem to the transportation problem?   Consider the non-negativity condition in step 4 of . How does this relate to the constraints of the dual problem to the transportation problem?  "
},
{
