...
},
{
  ...
  "number": "1.2.2",
  "title": "",
  "body": " canonical   Canonical in this context refers to the fact that for both of the above problems, the are non-negative, and each bound is an inequality.  (In , we discuss noncanonical linear optimization problems, where these conditions ay fail.)  "
},
{
  ...
  "number": "1.2.3",
  "title": "",
  "body": "   objective function  above are called objective functions .   "
},
{
  ...
  "number": "1.2.4",
  "title": "",
  "body": " feasible solution  solution, feasible   Any point satisfying either of the above set of inequalities are called feasible solutions .   "
},
{
  ...
  "number": "1.2.5",
  "title": "",
  "body": " optimal solution  solution, optimal   Any feasible solution which maximizes (minimizes) the objective function is called an optimal solution .   "
},
{
  "id": "activity-change",
  "level": "2",
...
{
  "id": "sec-superconstrained-4",
  "level": "2",
  "url": "sec-superconstrained.html#sec-superconstrained-4",
  "type": "Observation",
  "number": "3.2.1",
  "title": "",
...
},
{
  ...
  "body": " Max Flow Algorithm  max flow algorithm  algorithm, max flow   We describe an algorithm to find the maximum flow for , a capacitated network with a unique source and sink :    INITIALIZE: We begin with any feasible flow (including the zero flow.)    Pick an -path in from to such that:   Each forward edge of satisfies .   Eack backwards edge satisfies .    (If no such -path exists, GOTO 5)    Compute     Define a new flow as follows: for each forward edge of , , we add . For each backwards edge we subtract .  Let and GOTO 2    STOP. The flow is now optimal.     "
},
{
