...
},
{
  ...
  "body": " Problems for    For the following games, write out the payoff matrix and the reduced matrix after domination.   Rowan has a 3 of hearts, 4 of spades, 9 of spades and 10 of hearts. Collen has a 5 of spades, 6 of hearts, 7 of hearts and 8 of spades.  Each player selects a card without revealing it, and both players flip their cards over at the same time. If the suits are the same, then Rowan wins the sum of the two card values. Otherwise, Colleen wins that sum.   The same as (A) but reverse the payoff conditions for Rowan and Colleen.   Rowan picks an even integer from 1-10, and Colleen picks an odd integer from 1-10. If the difference is less than 4, the player who played the bigger number wins the sum of the two values. Otherwise the player who played the smaller number wins the sum of the two values.   Rowan picks an integer from 1-3. Colleen picks two guesses which may be the same. Colleen reveals their guesses one at a time. If they guess correctly, they win $ equal to the value of their other guess. If they do not guess correctly, Rowan wins $ equal to the sum of both guesses.    For each of the following, find the von Neumann value of the payoff matrix.                    "
},
{
  "id": "exercises-games-1",
  "level": "2",
  "url": "sec-exercisesgames.html#exercises-games-1",
  "type": "Exercise",
  "number": "5.4.1",
  "title": "",
  "body": " For the following games, write out the payoff matrix and the reduced matrix after domination.   Rowan has a 3 of hearts, 4 of spades, 9 of spades and 10 of hearts. Collen has a 5 of spades, 6 of hearts, 7 of hearts and 8 of spades.  Each player selects a card without revealing it, and both players flip their cards over at the same time. If the suits are the same, then Rowan wins the sum of the two card values. Otherwise, Colleen wins that sum.   The same as (A) but reverse the payoff conditions for Rowan and Colleen.   Rowan picks an even integer from 1-10, and Colleen picks an odd integer from 1-10. If the difference is less than 4, the player who played the bigger number wins the sum of the two values. Otherwise the player who played the smaller number wins the sum of the two values.   Rowan picks an integer from 1-3. Colleen picks two guesses which may be the same. Colleen reveals their guesses one at a time. If they guess correctly, they win $ equal to the value of their other guess. If they do not guess correctly, Rowan wins $ equal to the sum of both guesses.  "
},
{
  ...
  "number": "5.4.2",
  "title": "",
  "body": " For each of the following, find the von Neumann value of the payoff matrix.                  "
},
{
  "id": "sec-vam",
  "level": "1",
