...
},
{
  ...
  "number": "9.1.2",
  "title": "",
  "body": "  The branch and bound algorithm for solving an integer programming maximization problem is as follows:    Solve the relaxation of the linear programming problem. If the solution is integral STOP.    For some in the optimal solution found in the previous step, define two sub problems, one with additional constraint and     Pick one of the subproblems and solve the linear relaxation with the additional constraint.    If the solution is integral, RETURN to 3.    If the solution is less than any integral solution found, RETURN to 3.    If the problem is infeasible, RETURN to 3.    Apply 2-6 to the new problem.    If all subproblems are explored, RETURN to 3 for parent problem.    Once the search tree has been exhausted, identify the optimal integral solution.     "
},
{
