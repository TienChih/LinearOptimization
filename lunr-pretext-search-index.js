...
},
{
  ...
  "number": "1.1.3",
  "title": "",
  "body": "  Consider the matrix      Describe neccesary and sufficient conditions for the columns to be linearly independent.      Describe neccesary and sufficient conditions for the columns to be a spanning set.      Describe necessary and sufficient conditions for the columns to be a basis for .    "
},
{
  "id": "sec-intro-6",
  "level": "2",
...
},
{
  ...
  "number": "4.5.12",
  "title": "",
  "body": "  Solve the following non-canonical primal-dual problems:                                                                                                                                                                                                                                                                                                                                                                                                  "
},
{
  "id": "sec-minmaxgames",
  "level": "1",
...
},
{
  ...
  "number": "5.5.8",
  "title": "",
  "body": "  Consider the payoff matrix      Find necessary and sufficient conditions for this matrix to be reduced by domination.      Find the von Neumann value and optimal strategies for each player for the game above. There may be multiple cases.    "
},
{
...
},
{
  ...
  "number": "6.2.4",
  "title": "",
  "body": "  Consider the tableau:                                                                  Perform steps 2-5. How much was shifted along the cycle in step 5?      What is the analogous type of pivot when performing the Simplex Algorithm ?    "
},
{
...
},
{
  ...
  "body": " conservation of flow  theorem, conservation of flow  Conservation of Flow   For a capacitated network , .   "
},
{
...
},
{
  ...
  "number": "7.3.1",
  "title": "",
  "body": "  Dr. Ayad is driving from her home to Fantasi College. The town is connected by a series of one way streets, each labeled with the time it would take to traverse the road.   A Network Flow depicting several nodes and edges with weights.       What is the shortest amount of time needed for her to arrive at Fantasi College?      Is there a unique route she could take that minimizes this time?    "
},
{
...
},
{
  ...
  "number": "8.1.6",
  "title": "",
  "body": "  The complete search tree for is as follows   A Tree Diagram describing additional constraints.    We start at Node 0, and identify the two subproblems. We explore the subproblem where in Node 1, and again identify two subproblems. We stop and return at Node 2 because the solution was integral. We stop and return from Node 3, even though the solution is not integral, because the optimal solution for that subproblem was already less than the solution found in Node 1, and any further exploration would lead to a lower value still.  We then return to the starting node and to the other initial subproblem in Node 4, were . When we split into the the two subproblems, gives an integral solution in Node 5, and the constraint gives an infeasible problem.  Thus, we return, and of the two integral solutions found, has the highest value.   "
},
{
...
},
{
  ...
  "number": "9.1.9",
  "title": "",
  "body": " Prove that if a graph is bipartite, then it must not contain an odd length cycle The converse is also true, but we will leave that alone. .  "
},
{
  "id": "subsec-Konigs-7",
  "level": "2",
...
},
{
  ...
  "number": "9.4.3",
  "title": "",
  "body": "  We prove the case of where there are that minimize . We assume this is true.     Without loss of generality, let . Why can we do this?      Let . Sketch and .      We want to show that is the separating hyperplane. Suppose that was not contained in what must be true about ?      Let such that . Sketch .      Let decribe geometrically what represents. (Think dot product, projections and for to start at ).      Let , show that .      Let , show that       Show that .      Show that , and explain why .      Why does the last statement result in a contradiction?    "
},
{
  "id": "def-cone",
  "level": "2",
