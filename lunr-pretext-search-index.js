...
},
{
  ...
  "body": " Complementary Slackness   Prove that .    If are feasible, if , what does that say about ?  What about ?, ? ?    If are feasible optimal solutions with slack variables , what must be true about ?   "
},
{
...
},
{
  ...
  "number": "6.1.2",
  "title": "",
  "body": "  Consider the payoff matrix for a game between Rowan and Colleen.         Colleen                      Rowan                                                   Suppose that Rowan pursues a mixed strategy a probability distribution of their choices where   If Colleen chooses column as her strategy, what is the expected value of Rowan's earnings?     .     .     .     .     .     .      If Colleen somehow figures out Rowan's strategy , which column should she choose?    Rowan is aware that Colleen is a sharp player can likely figure out . How then should he choose his strategy? ?    Maximize .    Maximize .    Minimize .    Minimize .      At the exact same time, Colleen is pursuing her own mixed strategy :   If Rowan chooses row as his strategy, what is the expected value of Colleen's losses?     .     .     .     .     .     .      If Rowan somehow figures out Colleen's strategy , which row should he choose?    Colleen is also aware that Rowan is a sharp player can likely figure out . How then should she choose her strategy? ?    Maximize .    Maximize .    Minimize .    Minimize .      Consider the primal-dual program encoded by the tableau:                                                                                                                                                                                                                  Write out both the primal and dual problems encoded by this tableau. How do they relate to the Rowan and Colleen's strategies?    Show that the satisfy the conditions for to be mixed strategies.    In solving this system, some rows or columns may be deleted. Why is this okay?   "
},
{
  "id": "def-saddlepoint",
  "level": "2",
...
},
{
  ...
  "number": "7.1.1",
  "title": "",
  "body": "  Suppose we have a company moving goods (lets say widgets) from 3 different warehouses to 3 different markets. The cost of shipping from warehouses to markets is listed below, along with the demand from each market and the supply available at each warehouse:       Market 1  Market 2  Market 3      Warehouse 1  $2\/ton  $1\/ton  $2\/ton  40 tons    Warehouse 2  $9\/ton  $4\/ton  $7\/ton  60 tons    Warehouse 3  $1\/ton  $2\/ton  $9\/ton  10 tons      40 tons  50 tons  20 tons  110 tons     We want to ship the goods from the warehouses to the markets in a way that minimizes costs.    Let denote the cost to ship a ton of goods from warehouse to market .  Write an (in)equality that measure the cost to ship goods from Warehouse 1 in terms of the .    Write an (in)equality that measure the cost to ship goods to Market 2 in terms of the .    Write a (possibly noncanonical) linear minimization program that minimizes the cost to ship these goods.   "
},
{
  "id": "def-balanced",
  "level": "2",
...
},
{
  ...
  "number": "8.1.2",
  "title": "",
  "body": "  Graph theory is a rich, complex and deep area of study. Graphs theorists study a variety of graphs or objects called graphs, with a wide range of conventions. For the purposes of this chapter, graphs are directed, there is at most two edges between graphs (one in each direction), and loops are disallowed. Note that in general some or any of these conventions can be modified or removed.   "
},
{
  "id": "backmatter-2",
  "level": "1",
