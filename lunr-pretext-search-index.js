...
},
{
  ...
  "body": " Solving NonCanonical Problems with Sage    Say we want to solve the non-canonical linear optimization problem:       Record this non-canonical problem using Sage:   We can then find the optimal solution:     Note that we use the command InteractiveLPProblem rather than InteractiveLPProblemStandardForm for general (potentially non-canonical) linear optimization problems. Sage does not have a command for the Simplex Algorithm for InteractiveLPProblem .    Solve:           "
},
{
...
{
  "id": "sec-noncanonsage-4",
  "level": "2",
  "url": "sec-noncanonsage.html#sec-noncanonsage-4",
  "type": "Activity",
  "number": "3.3.2",
  "title": "",
  "body": "  Solve:          "
...
{
  "id": "sec-sensitivity-5",
  "level": "2",
  "url": "sec-sensitivity.html#sec-sensitivity-5",
  "type": "Activity",
  "number": "4.1.3",
  "title": "",
...
},
{
  ...
  "number": "4.1.1",
  "title": "",
  "body": " Recall the canonical maximization problem:     The dual minimization problem is aritculated as follows:     "
},
{
...
},
{
  ...
  "number": "4.2.2",
  "title": "",
  "body": "  For a primal maximization problem with objective function and dual objective , we have that   In particular, if there is a feasible primal solution and feasible dual solution such that then are optimal solutions for the primal and dual problems respectively.   "
},
{
...
},
{
  ...
  "body": " The Strong Duality Theorem   Given a pair of primal max-dual min problems, the primal max problem as an optimal solution if and only if the dual min problem has an optimal solution . Moreover, .   "
},
{
...
},
{
  ...
  "number": "4.3.3",
  "title": "",
  "body": " If a primal problem is infeasible, what could be true of the dual problem?   The dual problem has an optimal solution.    The dual problem is unbounded below.    The dual problem is infeasible.     Verify that the primal problem is infeasible.                                                                                         Take the negative transpose, then use the Simplex Algorithm to determine the nature of the dual problem.    Verify that the primal problem is infeasible.                                                                                         Take the negative transpose, then use the Simplex Algorithm to determine the nature of the dual problem.   "
},
{
  "id": "sec-dualpivot-6",
  "level": "2",
...
},
{
  "id": "sec-vonneumann-5",
  "level": "2",
  "url": "sec-vonneumann.html#sec-vonneumann-5",
  "type": "Activity",
  "number": "5.2.3",
  "title": "",
...
{
  "id": "sec-vonneumann-10",
  "level": "2",
  "url": "sec-vonneumann.html#sec-vonneumann-10",
  "type": "Activity",
  "number": "5.2.7",
  "title": "",
