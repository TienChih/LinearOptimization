...
},
{
  ...
  "number": "3.2.3",
  "title": "",
  "body": "  Consider the linear program:     Record this problem in a tableau with an equality constraint.                                                                                  Pivot on the entry with .                                                                                  We obtained a tableau of the form:                                                                              Rewrite the 3 rows as linear equalities, and verify that the 0 column contributes nothing.    Delete the 0 column and solve the remaining system.        "
},
{
...
},
{
  ...
  "body": " Solving NonCanonical Problems with Sage    Say we want to solve the non-canonical linear program:       Record this non-canonical problem using Sage:   We can then find the optimal solution:     Note that we use the command InteractiveLPProblem rather than InteractiveLPProblemStandardForm for general (potentially non-canonical) linear optimization problems. Sage does not have a command for the Simplex Algorithm for InteractiveLPProblem .    Solve:           "
},
{
  ...
  "number": "3.3.1",
  "title": "",
  "body": "  Say we want to solve the non-canonical linear program:       Record this non-canonical problem using Sage:   We can then find the optimal solution:    "
},
{
...
},
{
  ...
  "body": " The Strong Duality Theorem   Given a pair of primal max-dual min programs, the primal max problem as an optimal solution if and only if the dual min problem has an optimal solution . Moreover, .   "
},
{
...
},
{
  ...
  "number": "4.3.3",
  "title": "",
  "body": " If a primal problem is infeasible, what could be true of the dual program?   The dual problem has an optimal solution.    The dual problem is unbounded below.    The dual problem is infeasible.     Verify that the primal problem is infeasible.                                                                                         Take the negative transpose, then use the Simplex Algorithm to determine the nature of the dual program.    Verify that the primal problem is infeasible.                                                                                         Take the negative transpose, then use the Simplex Algorithm to determine the nature of the dual program.   "
},
{
  "id": "sec-dualpivot-6",
  "level": "2",
