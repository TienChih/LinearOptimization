...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": "  Consider the augmented matrix     Given a fixed , what is a neccesary condition for the values of so that the system of equations encoded by has a unique solution?    What does this mean geometrically?    If the rows of are independent, and , then what is the dimension of the solution space of ?   "
},
{
  "id": "activity-basis",
  "level": "2",
...
},
{
  ...
  "number": "1.2.2",
  "title": "",
  "body": "  Suppose Carlos planning on shopping for a meal. Mini bell peppers are $1.00 (simplified) a pound, Chicken is $1.25 a pound and Spaghetti with sauce is $0.80 a cup.  A pound of Bell Peppers has 500 units of vitamin A, 30 calories and 10 units of calcium. A pound of Chicken has 75 units of vitamin A, 280 calories and 22 units of calcium. A cup of Spaghetti with sauce has 2000 units of Vitamin A, 240 Calories and 52 units of Calcium.  Carlos needs a minimum of 640 calories, 1650 units of Vitamin A and 500 units of Calcium.    Let denote pounds of bell pepper, denote pounds of chicken and denote cups of spaghetti with sauce. Find three inequalities in terms of the for how much of each food Carlos should eat to meet his minimum dietary requirements.    How might we solve this problem? How is it different from ?    This seems like a wildly oversimplistic dietary problem, because it is. How might we complicate it for more realism?   "
},
{
...
},
{
  ...
  "number": "1.3.6",
  "title": "",
  "body": "   Let be defined by for some (ie is a half-space of ).     Let . Explain why for any .    Show that for any , that .    Let , that is, there are such that and . Show that for .    Conclude that is convex.   "
},
{
...
},
{
  ...
  "number": "2.1.1",
  "title": "",
  "body": "  Consider the canonical maximization problem:      slack variable  decision variable  variable, slack  variable, decision Note that we may rewrite this as a system of equalities by introducing the slack variables  . We will refer to the as decision variables .       What must be true about the slack variables ?                      Whixh of these must be an upper bound for ?                    could be unbounded.      "
},
{
  "id": "sec-pivot-4",
  "level": "2",
...
},
{
  ...
  "number": "2.1.5",
  "title": "",
  "body": "  Consider the region in bound by and . Let and   The feasible region for a canonical maximization problem.       If , what point(s) in satisfy ?    If , what point(s) in satisfy ?    what point(s) in satisfy both ?    what point(s) in satisfy both ?    what point(s) in satisfy both ? What about ?    "
},
{
  "id": "activity-widget",
  "level": "2",
...
},
{
  ...
  "number": "2.3.2",
  "title": "",
  "body": "  Consider the canonical linear optimization problem: Maximzie , subject to     Consider a sequence of pivots swapping ,  , . In each of these cases, what is the basic solution recorded by the tableau?    The feasible region with multiple lines intersecting the origin.      "
},
{
  "id": "def-Cycling",
  "level": "2",
...
},
{
  ...
  "number": "3.1.1",
  "title": "",
  "body": "  Suppose we wanted to solve the linear optimization problem:     What are some differences between this linear optimization problem and previous examples of optimization problems?    We can record the problem with the following tableau, we denote the variables which can be negative by circling them:                                                                                     What point currently represents the basic solution?    Suppose we pivot on the entry with the . What point has the basic solution moved to? (You do not need to fill in the tableau.)                                                                                       Suppose we pivot on the entry with the . What point has the basic solution moved to?                                                                                       Consider the plot of the feasible region. What did our two pivots do?       List all the hyperplanes that bound the feasible region.    Recall that each simplex pivot represents a shift of the basic solution from one extreme point to another. Which of the following do you believe is true?    Following the rules of pivoting through the Simplex Algorithm, we should be able to return to the origin, and this is consistent with our geometric viewpoint.    It is possible to perform pivots that don't neccesarily follow the rules of the Simplex Algorithm, to return to the origin, and this is consistent with our geometric viewpoint.    It is technically possible to perform pivots that don't neccesarily follow the rules of the Simplex Algorithm to return to the origin, and this is not consistent with our geometric viewpoint.     "
},
{
...
},
{
  ...
  "body": " Solving NonCanonical Problems with Sage   In , we showed how to use Sage to solve canonical linear optimization problems with the Simplex Algorithm. In this section, we use Sage to solve noncanonical problems.     Say we want to solve the non-canonical linear optimization problem:       Record this non-canonical problem using Sage:       Find the optimal solution:     Note that we use the command InteractiveLPProblem rather than InteractiveLPProblemStandardForm for general (potentially non-canonical) linear optimization problems. Sage does not have a command for the Simplex Algorithm for InteractiveLPProblem .    Solve:           "
},
{
  ...
  "number": "3.3.1",
  "title": "",
  "body": "  Say we want to solve the non-canonical linear optimization problem:       Record this non-canonical problem using Sage:       Find the optimal solution:    "
},
{
...
},
{
  ...
  "number": "4.1.2",
  "title": "",
  "body": "   In both and we essentially explore the idea of assigning values somehow to the bounds of a maximization problem.  Suppose you have a production problem, and you wish to acquire new materials to increase production. You then assign a value to each potential new material, according to which would benifit you the most. Which of the following should be reasonable things to expect from these values?    The value of each material is non-negative.    The total value of the materials should be as big as possible, to maximize costs associated with their value.    The total value of the materials should be as small as possible, to minimize costs associated with their value.    The total value of these materials should reflect the value of selling products made with those materials.    If a material is not to be used, it has zero value.     "
},
{
...
},
{
  ...
  "number": "4.2.6",
  "title": "",
  "body": "  We prove the case of where there are that minimize . We assume this is true.    Without loss of generality, let . Why can we do this?    Let . Sketch and .    We want to show that is the seperating hyperplane. Suppose that was not contained in what must be true about ?    Let such that . Sketch .    Let decribe geometrically what represents. (Think dot product, projections and for to start at ).    Let , show that .    Let , show that     Show that .    Show that , and explain why .    Why does the last statement result in a contradiction?   "
},
{
  "id": "def-cone",
  "level": "2",
...
{
  "id": "sec-dualitytheory-16",
  "level": "2",
  "url": "sec-dualitytheory.html#sec-dualitytheory-16",
  "type": "Activity",
  "number": "4.2.10",
  "title": "",
...
{
  "id": "sec-dualitytheory-20",
  "level": "2",
  "url": "sec-dualitytheory.html#sec-dualitytheory-20",
  "type": "Activity",
  "number": "4.2.14",
  "title": "Complementary Slackness.",
  "body": " Complementary Slackness   We assume the primal problem is canonical.    Prove that .    Suppose is a feasible extreme point, and are the corresponding coefficients for the normal vectors. If , what does that say about ?     is the coefficient of the normal vector for the plane . If the feasible solution does not lie on , what can we say about ?    What about ?, ? ?    If are feasible optimal solutions with slack variables , what must be true about ?   "
},
{
...
},
{
  ...
  "number": "4.4.2",
  "title": "",
  "body": " Suppose that a company is painting figurines, 4 colors . The colors are mixed from red, green and blue paint.   takes 2 oz of red, 2 oz green and 1 oz blue. takes 3 oz of red, 1 oz green and 1 oz blue. takes 1 oz of red, 2 oz green and 2 oz blue. takes 1 oz of red and 4 oz blue.  Figurines with color sell for $20, colored figures sell for $25 dollars and colored figurines sell for $30. The company has many figurines to paint and 100 oz each of red, green and blue paint. How many of each colored figurine should be painted to maximize revenue?   Solve the above canonical maximization problem and restate the objective function in terms of the .   If we had 110 oz red, 100 oz green, and 100 oz blue paint, without resolving the problem, what would the optimal revenue be?   If we had 95 oz red, 100 oz green, and 100 oz blue paint, without resolving the problem, what would the optimal revenue be?   If we had 100 oz red, 110 oz green, and 100 oz blue paint, without resolving the problem, what would the optimal revenue be?   If we had 100 oz red, 100 oz green, and 95 oz blue paint, without resolving the problem, what would the optimal revenue be?  "
},
{
...
},
{
  ...
  "number": "4.4.4",
  "title": "",
  "body": " Suppose the maximum value of the objective function of a linear optimization problem is attained at the point with the first variables as decision variables. Determine if the following are TRUE or FALSE:    If we increase , the value of the objective function is still .    If we increase , the value of the objective function is still .    "
},
{
  "id": "ex-duality",
  "level": "2",
...
},
{
  ...
  "number": "4.4.10",
  "title": "",
  "body": " Consider a two variable, two constraint primal maximization problem.                                                                                   Recall Weak Duality , and Complementary Slackness, . Suppose we found a pair of primal-dual solutions which satisfied main constraints, but failed one or more non-negativity constraints.   Must the Weak Duality still hold? Prove or find a counterexample.   Suppose there were a pair of such solutions so that , must complementary slackness still hold? Prove or find a counterexample.  "
},
{
  ...
  "number": "4.4.11",
  "title": "",
  "body": "complementary slackness theorem theorem, complementary slackness Prove that for a canonical problem, feasible solutions , with slack variables exhibt complementary slackness if and only if are optimal. (This fact is commonly known as the Complementary Slackness Theorem .) "
},
{
...
},
{
  ...
  "body": " VonNeumann's Minimax Theorem   Let be a payoff matrix and represent the strategies of the row and column players respectively, with feasible regions . Also let denote the th row of a matrix and let denote the th column of .  Then, there are optimal strategies such that:   We call this value described the VonNeumann Value of the game.   "
},
{
...
},
{
  ...
  "number": "5.4.5",
  "title": "",
  "body": "For each exercise in , determine the VonNeumann value and the optimal strategy. "
},
{
...
},
{
  ...
  "number": "5.4.8",
  "title": "",
  "body": " Consider the payoff matrix    Find neccesary and sufficient conditions for this matrix to be reduced by domination.   Find the VonNeumann value and optimal strategies for each player for the game above. There may be multiple cases.  "
},
{
  ...
  "number": "5.4.9",
  "title": "",
  "body": " Consider the payoff matrix where .   Find the VonNeumann value and optimal strategies for each player for the game above.   Suppose could be any value, when does this matrix reduce via domination?   Find the VonNeumann value and optimal strategies for each player for the game above if could be any value.  "
},
{
  ...
  "number": "5.4.10",
  "title": "",
  "body": " Consider the payoff matrix where .   Find the optimal solutions and the VonNeumann value for the above game. (Without loss of generality, we may assume are positive, why?)   Prove that in a game with a two by two payoff matrix where the optimal solution for each player is a pure strategy , then the matrix has a saddle point.   Prove via contradiction that in a game with a reduced payoff matrix where the optimal solution for each player is a pure strategy , then the matrix has a saddle point.  "
},
{
  "id": "sec-vam",
  "level": "1",
...
},
{
  ...
  "number": "6.2.2",
  "title": "",
  "body": "  Recall the transportation tableau obtained in :        NA   NA   NA       NA                 NA                 NA                                Note that this tableau corresponds to a basic feasible solution for the original minimization problem.    If this solution is not optimal, what should the next step be?    Pick a variable to exit the basis which increases the objective function and make the smallest change.    Pick a variable to exit the basis which decreases the objective function and make the smallest change.    Pick a variable to exit the basis which increases the objective function and make the biggest change.    Pick a variable to exit the basis which decreases the objective function and make the biggest change.      Select row values and column values so that each circled value is the sum of row and column values .  (We can think of these as analogous to the shadow costs associated with the warehouse\/market bounds)                                                                 Replace each entry of the tableau with . What does this measure? What does it mean if each entry is non-negative?    Pick a                                                                  Pick circled entries so that they with the boxed form a cycle , that is each of these entries shares a row with exactly one another of the entries, and a column with another of the entries.    Based on the discussion in (a), which entry should transfer their shipments to ?     .     .     .     .     .    How do the other entries in the cycle adjust? (There may be more than one valid choice.)    Remove the basis entry which is no longer being used, and recompute the with the new basis.                                                                                   Verify that none of the entries are non negative. Why do we now terminate?  We then replace the entries with the original entries                                                                 Use Sage to confirm the solution:       "
},
{
...
},
{
  ...
  "number": "6.2.4",
  "title": "",
  "body": "  Consider the tableau:                                                                 Perform steps 2-5. How much was shiftted along the cycle in step 5?    What is the analogous type of pivot when performing the Simplex Algorithm ?   "
},
{
...
},
{
  ...
  "number": "8.3.1",
  "title": "",
  "body": "  Say we want to solve the integer optimization problem:     Record this non-canonical problem using Sage:       We can then find the optimal solution:     We could also minimize if we chose:      We could also have solved the linear relaxation of the original problem if we chose:     "
},
{
  "id": "sec-intsage-4",
  "level": "2",
...
},
{
  ...
  "number": "9.3.1",
  "title": "",
  "body": "  Consider the last time you had to pick classes to fit a schedule. What were some things you had to consider in doing so? What sort of constraints did you consider neccesary, and which were considered preferences? How does your answers compare to your classmates?   "
},
{
...
},
{
  ...
  "number": "9.3.6",
  "title": "",
  "body": " For the truly ambitious, model a scheduling problem for the offering of courses , factoring in preferred times, preferred courses, preffered classrooms, changes in staffing, fluctuating student demand and flow of courses in the future etc. This is as open a problem as there can be. Someone who solves this problem will gain more recognition than if they solved all the Millennium Problems. .  "
},
{
  "id": "sec-lareview",
  "level": "1",
